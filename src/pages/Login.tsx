    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md animate-fade-in">
          ...
          {/* Demo Credentials */}
          <div className="mt-8 p-4 rounded-xl bg-secondary text-sm">
            <p className="font-medium mb-2">Demo Accounts:</p>
            <p className="text-muted-foreground">Student: student@test.com / password</p>
            <p className="text-muted-foreground">Admin: admin@test.com / password</p>
          </div>
        </div>
      </div>
      ...
      <div className="hidden lg:flex flex-1 gradient-primary items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="text-center text-primary-foreground relative z-10 max-w-lg">
          ...
          <p className="text-xl text-white/80">
            Pick up where you left off and keep improving your math skills every day.
          </p>
        </div>
      </div>
    </div>
